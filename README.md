...
| SD READER | Realtek RTS525A | Working✅ | Support SD card now. There was one time where the SD card dropped off but that was rare. Seems pretty stable so far. Will update if this changes. |
