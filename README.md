...
| SD READER | Realtek RTS525A | Working with sleep disabled✅⚠️| Pretty stable so far, but you might not wanna sleep if you want to use SDCard functionality. In some cases the SDcard will drop if you wake up from sleep. |
