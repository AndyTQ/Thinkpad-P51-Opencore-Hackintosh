...
| 1xUSB C (Thunderbolt) | | Partially working ⚠️| Theoretically possible for eGPU output (by plugging in the device before booting) since it worked in 10.15 as per https://github.com/AsahiKou/ThinkPadP51-Hackintosh-Catalina/issues/1. Untested for other devices. Currently does not support hot plug. |
